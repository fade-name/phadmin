...
layui.define(['jquery', 'form', 'laydate', 'upload', 'multiImgUpload', 'public'], function (exports) {
    ...
    let obj = {
        ...
        //初始化列表方法
        initList: function () {
            pub.initRowDelete('/backend/user/user_group/del');
        ...
        initAdd: function () {
            _this.pubCtrlInit();
            _this.dataVerify();
            pub.listenToSubmit('/backend/user/user_group/add', null, null, 1, '/backend/user/user_group/index');
        },
        ...
        initEdit: function () {
            ...
            pub.listenToSubmit('/backend/user/user_group/edit?edit_id=' + editId, 1, null, 1, '/backend/user/user_group/index');
        },
